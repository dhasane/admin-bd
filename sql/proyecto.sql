...
create or replace view vista_Funciones as
    SELECT OWNER, OBJECT_NAME AS funcion
    FROM DBA_PROCEDURES
...
create or replace view vista_Procedimientos as
    SELECT OWNER, OBJECT_NAME AS procedimiento
    FROM DBA_PROCEDURES
...
GRANT INSERT ON USUARIO_1.PRIMERATABLAUSUARIO_1 TO GRUPOUSUARIO;
GRANT INSERT ON USUARIO_1.SEGUNDATABLAUSUARIO_1 TO GRUPOUSUARIO;
GRANT INSERT ON USUARIO_1.TERCERATABLAUSUARIO_1 TO GRUPOUSUARIO;

GRANT INSERT ON USUARIO_2.PRIMERATABLAUSUARIO_2 TO GRUPOUSUARIO;
GRANT INSERT ON USUARIO_2.SEGUNDATABLAUSUARIO_2 TO GRUPOUSUARIO;
GRANT INSERT ON USUARIO_2.TERCERATABLAUSUARIO_2 TO GRUPOUSUARIO;

GRANT INSERT ON USUARIO_3.PRIMERATABLAUSUARIO_3 TO GRUPOUSUARIO;
GRANT INSERT ON USUARIO_3.SEGUNDATABLAUSUARIO_3 TO GRUPOUSUARIO;
GRANT INSERT ON USUARIO_3.TERCERATABLAUSUARIO_3 TO GRUPOUSUARIO;

GRANT INSERT ON USUARIO_4.PRIMERATABLAUSUARIO_4 TO GRUPOUSUARIO;
GRANT INSERT ON USUARIO_4.SEGUNDATABLAUSUARIO_4 TO GRUPOUSUARIO;
GRANT INSERT ON USUARIO_4.TERCERATABLAUSUARIO_4 TO GRUPOUSUARIO;

GRANT INSERT ON USUARIO_5.PRIMERATABLAUSUARIO_5 TO GRUPOUSUARIO;
GRANT INSERT ON USUARIO_5.SEGUNDATABLAUSUARIO_5 TO GRUPOUSUARIO;
GRANT INSERT ON USUARIO_5.TERCERATABLAUSUARIO_5 TO GRUPOUSUARIO;

GRANT INSERT ON USUARIO_6.PRIMERATABLAUSUARIO_6 TO GRUPOUSUARIO;
GRANT INSERT ON USUARIO_6.SEGUNDATABLAUSUARIO_6 TO GRUPOUSUARIO;
GRANT INSERT ON USUARIO_6.TERCERATABLAUSUARIO_6 TO GRUPOUSUARIO;

ALTER USER PEPITO QUOTA UNLIMITED ON TABLASPROYECTO;
...
--SACAR TABLAS Y SUS DUE�OS
-- select TABLE_NAME, OWNER
-- from all_tables
-- where owner <>'USUARIO_1' and tablespace_name = 'TABLASPROYECTO'
-- order by table_name;

-- SACAR JOB, DUE�O DEL JOB Y SI EST� ACCTIVO O NO

-- SELECT *
-- FROM vista_jobs;


-- Sacar tablespaces y sus tama�os y eso

-- Select t.tablespace_name,
--     ROUND(MAX(d.bytes)/1024/1024,2) AS Tama�o,
--     ROUND((MAX(d.bytes)/1024/1024) -
--     (SUM(decode(f.bytes, NULL,0, f.bytes))/1024/1024),2) AS Usados,
--     ROUND(SUM(decode(f.bytes, NULL,0, f.bytes))/1024/1024,2) AS Libres
-- FROM DBA_FREE_SPACE f, DBA_DATA_FILES d,  DBA_TABLESPACES t
