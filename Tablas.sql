...
CREATE USER USUARIO_1 IDENTIFIET BY USUARIO_1 DEFAULT TABLESPACE USUARIOS;
CREATE USER USUARIO_2 IDENTIFIET BY USUARIO_2 DEFAULT TABLESPACE USUARIOS;
CREATE USER USUARIO_3 IDENTIFIET BY USUARIO_3 DEFAULT TABLESPACE USUARIOS;
CREATE USER USUARIO_4 IDENTIFIET BY USUARIO_4 DEFAULT TABLESPACE USUARIOS;
CREATE USER USUARIO_5 IDENTIFIET BY USUARIO_5 DEFAULT TABLESPACE USUARIOS;
CREATE USER USUARIO_6 IDENTIFIET BY USUARIO_6 DEFAULT TABLESPACE USUARIOS;
CREATE USER USUARIO_7 IDENTIFIET BY USUARIO_7 DEFAULT TABLESPACE USUARIOS;
